...
- [#8](https://github.com/deltaDAO/pontusx-registry-hooks/pull/8) [`23f9f2d`](https://github.com/deltaDAO/pontusx-registry-hooks/commit/23f9f2d6241d4a7fab3b732bfe207e2a5fb80cd4) Thanks [@moritzkirstein](https://github.com/moritzkirstein)! - Add search functionality to `usePontusXRegistry` hook with support for:
